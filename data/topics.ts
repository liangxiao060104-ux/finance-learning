...
- 保障要全面`
  ...
  },
  {
    ...
    sections: [
      {
        title: '需求理论',
        content: `需求：消费者在某一价格水平愿意且能够购买的商品数量。

**需求定律**：在其他条件不变的情况下，商品的需求量与价格呈反向变动。
- 需求曲线向右下方倾斜
- 价格变动引起需求量的变动（沿曲线移动）
...
**供给定律**：在其他条件不变的情况下，商品的供给量与价格呈同向变动。
- 供给曲线向右上方倾斜
- 价格变动引起供给量的变动（沿曲线移动）
...
- 长期供给弹性通常大于短期`
      ...
      {
        title: '均衡价格理论',
        content: `**均衡**：供给等于需求的状态，此时的价格为均衡价格，数量为均衡数量。
